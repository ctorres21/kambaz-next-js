...
<label  htmlFor="wd-select-one-genre"></label><br/>
            <select id="wd-select-one-genre">
            <option value="publish">Publish All</option>
            <option value="other">Other option</option>
            <option selected value="other2">
                Publish</option>
            </select>
      <button type="button">+ Module</button> 
      <ul id="wd-modules">
        <li className="wd-module">
          <div className="wd-title">Week 1, Lecture 1 - Course Introduction, Syllabus, Etc</div>
          <ul className="wd-lessons">
            <li className="wd-lesson">
              ...
              <ul className="wd-content">
                ...
                <li className="wd-content-item">Full Stack Developer - Chapter - Create</li>
              </ul>
